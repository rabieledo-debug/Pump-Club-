    ...
    <aside className="w-64 bg-slate-950/95 border-l border-slate-800/80 flex flex-col h-screen select-none shrink-0 sticky top-0">
      ...
      <div className="p-5 border-b border-slate-800/80 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-500/20 ring-2 ring-amber-500/20">
            <Dumbbell className="w-5 h-5 text-slate-950 font-black" />
          </div>
          <div>
            <h1 className="text-base font-black tracking-wider text-white uppercase flex items-center gap-1">
